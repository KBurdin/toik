#ifndef RKEDITDIALOG_H
#define RKEDITDIALOG_H
...
class RKEditDialog : public ValDialog
{
    Q_OBJECT

public:
    explicit RKEditDialog(QTableView *table, QAbstractItemModel *model, QWidget *parent = nullptr);
